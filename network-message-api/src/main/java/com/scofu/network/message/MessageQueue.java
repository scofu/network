...
/**
 * Builds "queues" for messages and requests.
 * <br>
 * This does not represent an actual AMQP queue. Messages "pushed" here are internally (under AMQP)
 * sent in a global exchange with the topic as its routing key.
 * <br>
 ...
 * expected reply. If the type of the reply is {@link Void}, no reply is expected.
 * <br>
