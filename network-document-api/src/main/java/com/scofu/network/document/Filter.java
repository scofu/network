...
/**
 * https://docs.mongodb.com/manual/reference/method/db.collection.find/#db.collection.find-- <br>
...
public interface Filter {
   ...
   * @param <T> the type of the values
   */
  static <T> Filter where(
      String k1, T t1, String k2, T t2, String k3, T t3, String k4, T t4, String k5, T t5) {
